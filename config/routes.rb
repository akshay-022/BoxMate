Rottenpotatoes::Application.routes.draw do
  ...
  put '/customers/:id/destroy_entry'=> "customers#destroy_entry", as: 'destroy_customer_entry'
  get '/customers/:id/choose_entry'=> "customers#choose_entry", as: 'choose_customer_entry'
end
